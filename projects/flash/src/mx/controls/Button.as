...
include "C:/dev/f2/sdk/frameworks/mx/styles/metadata/FocusStyles.as"
include "C:/dev/f2/sdk/frameworks/mx/styles/metadata/LeadingStyle.as"
include "C:/dev/f2/sdk/frameworks/mx/styles/metadata/PaddingStyles.as"
include "C:/dev/f2/sdk/frameworks/mx/styles/metadata/SkinStyles.as"
include "C:/dev/f2/sdk/frameworks/mx/styles/metadata/TextStyles.as"
...
{
    include "C:/dev/f2/sdk/frameworks/mx/core/Version.as";
...
//		currentState = value;
    ...
    mx_internal function viewSkinForPhase(skinName:String):void
    {
        ...
        var newSkin:IFlexDisplayObject =
            IFlexDisplayObject(getChildByName("skin"));
		if(newSkin != null)
			setState = true;
		else
	        newSkin = IFlexDisplayObject(getChildByName(skinName));
        ...
        if (!newSkin)
        {
            ...
            if (newSkinClass)
            {
                ...
                newSkin.name = (setState)? "skin":skinName;
        ...
        */
        if(setState)
        {
	        if("currentState" in currentSkin)
	    	{
	    		var idx:Number = skinName.indexOf("Skin");
	    		Object(currentSkin).currentState = skinName.slice(0,idx);
	    	}
        }
    }
