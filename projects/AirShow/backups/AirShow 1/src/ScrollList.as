package
{
	...
	public class ScrollList extends DataDrivenControl implements ITileInfo
	{
		...
		public function set direction(v:String):void {horizontal = (v == "horizontal");_mgr.horizontal = horizontal;invalidateDisplayList()}
...
//					_mgr.completeSearch(lead,tileWidth);
