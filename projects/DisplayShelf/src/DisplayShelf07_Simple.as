package
{
	...
	public class DisplayShelf07_Simple extends UIComponent implements IHistoryManagerClient, IFocusManagerComponent
	{
		//---------------------------------------------------------------------------------------
		// constructor
		//---------------------------------------------------------------------------------------

		public function DisplayShelf07_Simple()
		{
			super();
	    ...
	    private function startAnimation():void
	    {
			...
			var cp:ChildPosition = new ChildPosition();
			var animations:Array = [];
				
			for(var i:int = 0;i<_children.length;i++)
			{
				var aa:AnimateAll = new AnimateAll();
				calcPositionForSelection(i,_safeSelectedIndex,cp);
