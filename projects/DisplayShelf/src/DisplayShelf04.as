package
{
	...
	public class DisplayShelf04 extends UIComponent 
	{
		//---------------------------------------------------------------------------------------
		// constructor
		//---------------------------------------------------------------------------------------

		public function DisplayShelf04()
		{
			super();
		...
		override protected function commitProperties():void
		{
			if(_itemsDirty)
			{
				...
				{
					var t:TiltingPane04 = new TiltingPane04();
					_children[i] = t;
		...
		{
			var t:TiltingPane04 = _children[i];
			var selected:TiltingPane04 = _children[sel];
			var adjacent:TiltingPane04;
			var a:Number = _angle;
			if(i == sel)
			{
				c.scale = 1;
