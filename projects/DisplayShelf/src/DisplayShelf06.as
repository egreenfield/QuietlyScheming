package
{
	...
	public class DisplayShelf06 extends UIComponent implements IHistoryManagerClient, IFocusManagerComponent
	{
		//---------------------------------------------------------------------------------------
		// constructor
		//---------------------------------------------------------------------------------------

		public function DisplayShelf06()
		{
			super();
		...
		override protected function commitProperties():void
		{
			if(_itemsDirty)
			{
				...
				{
					var t:TiltingPane06 = new TiltingPane06();
		...
		{
			var t:TiltingPane06 = _children[i];
			var selected:TiltingPane06 = _children[sel];
			var adjacent:TiltingPane06;
			var a:Number = _angle;
			if(i == sel)
			{
				c.scale = 1;
				...
				c.y = unscaledHeight - t.getExplicitOrMeasuredHeight();
				c.angle = 0;
			}
			else if (i < sel)
			{
				...
				c.y = unscaledHeight - t.getExplicitOrMeasuredHeight()* (1-_popout);
			}
			else
			{
				c.scale = (1-_popout);
