package
{
	...
	public class TiltingPane07 extends UIComponent
	{
		//---------------------------------------------------------------------------------------
		// constructor
		//---------------------------------------------------------------------------------------

		public function TiltingPane07()
		{
			super();
		}
		...
		public function set actualAngle(value:Number):void
		{
			_angle = value;
			invalidateDisplayList();
		}
		public function get actualAngle():Number
		{
			return _angle;
		}

		public function set unmeasuredScale(value:Number):void
		{
			var m:Matrix = transform.matrix;
			m.a = m.d = value;
			transform.matrix = m;
		}
		public function get unmeasuredScale():Number
		{
			return transform.matrix.a;
		}
