...
package Singularity.Geom.P3D
{
  ...
  import Singularity.Geom.P3D.FastCubicSpline;
  
  public class Composite extends EventDispatcher
  {
  	// planes
  	public static var XY:String = "XY";
  	public static var XZ:String = "XZ";
  	public static var YZ:String = "YZ";
...
*/
    ...
    public function arcLengthAt(_t:Number):Number { throw new Error("Composite::arcLengthAt() must be overriden") }
     ...
     public function addControlPoint(_xCoord:Number, _yCoord:Number, _zCoord:Number):void {throw new Error("Composite::addControlPoint() must be overriden")}
    
    public function moveControlPoint(_indx:uint, _newX:Number, _newY:Number, _newZ:Number):void {throw new Error("Composite::addControlPoint() must be overriden")}
    ...
    public function getZ(_t:Number):Number {throw new Error("Composite::getZ() must be overriden")}
  }
}