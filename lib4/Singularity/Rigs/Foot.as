//
// Foot.as - Manager class for a simple Biped Foot (toe links not currently used for simple 2D characters - this will be done later with a MultiConnector).
//
...
{  
  ...
  public class Foot extends Connector
  { 
  	public static const LEFT:String  = "L";
  	public static const RIGHT:String = "R";
  	  	
  	// The rig *must* supply a drawing Template for the foot
    public function Foot(_x:Number, _y:Number, _w:Number, _h:Number, _type:String, _t:Template, _r:uint, _c:uint):void
    {
      super(_x, _y, _w, _h);
